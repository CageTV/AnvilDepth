...
**Small (100MB):** https://huggingface.co/onnx-community/depth-anything-v2-small/blob/main/onnx/model.onnx -> save as `depth_anything_v2_small.onnx`

**Large (1.3GB, best quality):**